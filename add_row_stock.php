...
if(isset($_GET['count']))
{
    ...
    $output .= '<div class="col-md-2"> <br>
                <select  id="products'.$count.'" name="products[]" class="form-control select2" style="width:100%">
                <option value="0">Choose</option>';
                $select_f = "SELECT * FROM product";
    ...
    $output.='<div class="col-md-1"> <br>
                <input type="text" name="pack[]" id="pack'.$count.'" class="form-control" > 
               </div>
               <div class="col-md-2"> <br>
                <input type="text" name="qunatity[]" id="qunatity'.$count.'" class="form-control" > 
               </div>
               <div class="col-md-1"> <br>
                <input type="text" name="price[]" id="price'.$count.'" class="form-control" > 
               </div>
               <div class="col-md-1"> <br>
                <input type="text" name="bonus[]" id="bonus'.$count.'" class="form-control" > 
               </div>
               <div class="col-md-1"> <br>
