...
<h2 style="text-align: center;" class="font-weight-bold mb-1"><b> <i>SIZE INFORMATION</i></b></h2><br>
</div>
   <div class="row" >
    <div class="col-md-5">
              ...
              $res1=mysqli_query($connection,$que1);
                ...
                <tr>
                    ...
                    <td class="text-center">
                      <div class="btn-group">
                        <a href="update_size.php?gid=<?php echo $row['id'];?>"  class="btn btn-xs btn-warning" data-toggle="tooltip" title="Edit">
                          <span class="glyphicon glyphicon-edit"></span>
                        </a>
                        <a href="add_size.php?id=<?php echo $row['id'];?>"  class="btn btn-xs btn-danger" data-toggle="tooltip" title="Remove">
...
if (isset($_GET['id'])) {
    $id=$_GET['id'];
$que2="DELETE FROM `sizes` WHERE id='$id'";
