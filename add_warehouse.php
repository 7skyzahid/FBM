...
<div class="box-header with-border">
<h2 style="text-align: center;" class="font-weight-bold mb-1"><b> <i>Add Warehouse <br><br> <a href="view_warehouse.php" class="btn btn-primary" >View Warehouse</a> </i></b></h2><br>
</div>
   <div class="row" >
...
<input type="text"  class="form-control input-sm" name="capicity"  placeholder="Capicity" >
</div></div>
</div>
...
$query ="INSERT INTO warehouses(warehouse_name,warehouse_address,capacity,created_at)
VALUES ('$name','$address','$capicity','$date')";
    $result = mysqli_query($connection, $query);
    if($result){
   echo' <script>window.location.href = "add_warehouse.php";</script>';
}
