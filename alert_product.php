...
<h2 style="text-align: center;" class="font-weight-bold mb-1"><b> <i>MIN PRODUCT INFORMATION</i></b></h2><br>
</div>
...
$fetch =  "SELECT product_id,quantity,pur_price,supplier_id,sale_price,expiry_date,total_price,SUM(quantity) as qnt 
           FROM  stock_items WHERE quantity<='$minqnty' AND product_id='$prodid'  ";
