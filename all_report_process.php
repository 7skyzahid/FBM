...
if(isset($_POST['supplier']) && isset($_POST['supplier']) && isset($_POST['start_date']) && isset($_POST['end_date'])  )
 {
  $sup_search = $_POST['supplier'];
  $com_search = $_POST['company'];
