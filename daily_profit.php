...
<h2 style="text-align: center;" class="font-weight-bold mb-1"><b> <i>PROFIT & LOSS (Daily) </i></b></h2><br>
</div>
      ...
      <div id="mainDiv"  class="row">
        ...
        <div id="mainDD" >
          ...
          <div id="div3"  class="col-md-3 " style="margin-top: 45px">
            <h5><strong>Profit & Loss Daily <br>( Report Date: )</strong></h5>
            <h4><strong> 
              <?php
              $date =  date('d-M-Y');
              echo $date; 
                      ...
                      <div class="table-responsive">
                          <table class="table table-striped table-bordered table-hover" id="sample_1">
                              ...
                              <tbody id="display" >
                                ...
                                $grand_total  = 0;
                                $date = date('Y-m-d');
                                $profit = "SELECT profit.created_date AS dates , GROUP_CONCAT( DISTINCT profit.name ORDER BY profit.name ASC SEPARATOR '<br><br>' ) AS names ,GROUP_CONCAT(profit.description) AS descr , SUM(profit.debit) AS debits,SUM(profit.credit) AS credits FROM profit WHERE profit.created_date = '$date'  GROUP by profit.created_date order by profit.name ASC  ";
