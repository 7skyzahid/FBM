...
<h2 style="text-align: center;" class="font-weight-bold mb-1"><b> <i>SALES REPORT (DAILY)</i></b></h2><br>
</div>
              ...
              <div class="row">
                 ...
                 <div class="col-md-2">
                  ...
                  <div id="div3"  class="col-md-3 " style="margin-top: 45px">
                    <h5><strong>Daily Sales Report <br>( Report Date: )</strong></h5>
                    <h4><strong> 
                      <?php
                      $date =  date('d-M-Y');
                      echo $date; 
                      ...
                      <div class="table-responsive">
                        <table class="table table-striped table-bordered table-hover " id="sample_1">
                            ...
                            <tbody>
                              ...
                              // $daily = " SELECT s.quantity, date_format(s.created_at, '%Y-%m-%e') AS created_at, p.title, SUM(p.sale_price * s.quantity ) AS total_seling_price FROM sale_details s
                              // LEFT JOIN stock_items p ON s.stock_item_id = p.id
                              // WHERE DATE_FORMAT(s.created_at, '%Y-%m' ) = '{$year}-{$month}'
                              // GROUP BY DATE_FORMAT( s.created_at,  '%e' ),s.stock_item_id ";
                              $grand = 0;
                              $date =  date('Y-m-d');
                             ...
                             <tr >
                               <td colspan="5"></td>
                               <td colspan="1"><p style="font-weight: bold">Grand Total: <?php echo $grand; ?></p></td>
