...
<h2 style="text-align: center;" class="font-weight-bold mb-1"><b> <i>PURCHASE DUES REPORT</i></b></h2><br>
</div>
        <div class="row">
...
<form class="clearfix" method="post" action="dues_by_date_purchase_process.php">
