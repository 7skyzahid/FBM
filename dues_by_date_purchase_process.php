...
<h2 style="text-align: center;" class="font-weight-bold mb-1"><b> <i>PURCHASE DUES REPORT BY DATE</i></b></h2><br>
</div>
...
$select_date = "
SELECT purchase_dues_history.grand_total,purchase_dues_history.paid_total,purchase_dues_history.paid_new,
purchase_dues_history.due,purchase_dues_history.created_at,suppliers.name as supplier
FROM (purchase_dues_history 
INNER JOIN suppliers ON  purchase_dues_history.supplier_id=suppliers.id )
WHERE purchase_dues_history.created_at BETWEEN '$date1' AND '$date2' AND suppliers.id='$supplier' 
";
...
if (e.which == 8) {
window.location.href = "dues_by_date.php";
}
};
</script>
