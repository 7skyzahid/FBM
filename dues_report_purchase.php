...
<h2 style="text-align: center;" class="font-weight-bold mb-1"><b> <i>PURCHASE DUES</i></b></h2><br>
</div>
...
$fetch ="SELECT * FROM  purchase_amount WHERE due_amount > '$value' ";
...
$query1 ="SELECT * FROM  suppliers WHERE id='$sup_id' ";
...
<tr>
    ...
    <td><?php echo $date; ?></td>
     <td class="text-center">
      <div class="btn-group">
        <a href="update_purchase_ammount.php?gid=<?php echo $row['id'];?>"  class="btn btn-xs btn-warning" data-toggle="tooltip" title="Edit">
